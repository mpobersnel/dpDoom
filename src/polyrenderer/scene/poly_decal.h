...
{
public:
	static void RenderWallDecals(PolyRenderThread *thread, const Mat4f &worldToClip, const PolyClipPlane &clipPlane, const seg_t *line, uint32_t stencilValue);

private:
	void Render(PolyRenderThread *thread, const Mat4f &worldToClip, const PolyClipPlane &clipPlane, DBaseDecal *decal, const seg_t *line, uint32_t stencilValue);
