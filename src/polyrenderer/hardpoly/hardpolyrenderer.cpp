...
void HardpolyRenderer::CompileShaders()
{
	if (!mOpaqueProgram)
	{
		...
		mOpaqueProgram->Compile(GPUShaderType::Vertex, screen->GetContext()->IsOpenGL() ? "shaders/hardpoly/glsl/opaque.vp" : "shaders/hardpoly/hlsl/opaque.vp");
		mOpaqueProgram->Compile(GPUShaderType::Fragment, screen->GetContext()->IsOpenGL() ? "shaders/hardpoly/glsl/opaque.fp" : "shaders/hardpoly/hlsl/opaque.fp");
	...
	if (!mRectProgram)
	{
		...
		mRectProgram->Compile(GPUShaderType::Vertex, screen->GetContext()->IsOpenGL() ? "shaders/hardpoly/glsl/rect.vp" : "shaders/hardpoly/hlsl/rect.vp");
		mRectProgram->Compile(GPUShaderType::Fragment, screen->GetContext()->IsOpenGL() ? "shaders/hardpoly/glsl/rect.fp" : "shaders/hardpoly/hlsl/rect.fp");
	...
	if (!mStencilProgram)
	{
		...
		mStencilProgram->Compile(GPUShaderType::Vertex, screen->GetContext()->IsOpenGL() ? "shaders/hardpoly/glsl/stencil.vp" : "shaders/hardpoly/hlsl/stencil.vp");
		mStencilProgram->Compile(GPUShaderType::Fragment, screen->GetContext()->IsOpenGL() ? "shaders/hardpoly/glsl/stencil.fp" : "shaders/hardpoly/hlsl/stencil.fp");
