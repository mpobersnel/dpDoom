...
class HardpolyNoAccelPlayerSprite
{
public:
	short x1 = 0;
	short x2 = 0;
...
class HardpolyHWAccelPlayerSprite
{
public:
	FTexture *pic = nullptr;
	double texturemid = 0.0;
...
class HardpolyRenderPlayerSprites
{
public:
	void Render();
...
private:
	...
	TArray<HardpolyHWAccelPlayerSprite> AcceleratedSprites;
	sector_t tempsec;
};
